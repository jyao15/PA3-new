...
public abstract class Tree {
    ...
    /**
     * Switch_Case statements, of type Switch/CaseDef.
     */
    public static final int CASES = LABELLED + 1;
    public static final int CASE = CASES + 1;
    public static final int NORMALCASE = CASE + 1;
    public static final int DEFAULTCASE = NORMALCASE + 1;
    
    /**
     * Synchronized statements, of type Synchonized.
     */
    public static final int SYNCHRONIZED = DEFAULTCASE + 1;
    ...
    /**
     * Super statements, of type Super.
     */
    public static final int SUPER = ERRONEOUS + 1;

    /**
     * Copy statements, of type DCopy/SCopy.
     */
    public static final int DCOPY = SUPER + 1;
    public static final int SCOPY = DCOPY + 1;
    
    /**
     * Do statements, of type DoStmt/DoSubStmt.
     */
    public static final int DOSTMT = SCOPY + 1;
    public static final int DOSUBSTMT = DOSTMT + 1;
    
    /**
     * Unary operators, of type Unary.
     */
    public static final int POS = DOSUBSTMT + 1;
    ...
    public static final int IMGPART = POSTDEC + 1;
    public static final int RELPART = IMGPART + 1;
    public static final int TRANSINT = RELPART + 1;
     ...
     */
    public static class PrintComp extends Print {
    ...
    public static class DoStmt extends Tree {
    	...
    	public List<DoSubStmt> subStmts ; 

        public DoStmt(List<DoSubStmt> subStmts, DoSubStmt subStmt, Location loc) {
            super(DOSTMT, loc);
            this.subStmts = subStmts ;
            this.subStmts.add(subStmt) ;
        }
    	...
    	public void printTo(IndentPrintWriter pw) {
    		...
    		pw.println("branches");
    		pw.incIndent();
    		for(DoSubStmt subStmt : subStmts) {
    			subStmt.printTo(pw) ;
    		}
    		pw.decIndent();
    		pw.decIndent();
    ...
    public static class CaseDef extends Expr {

    	public Literal caseValue ;
    	public Expr expr ;
    	public int typeTag ;
        public CaseDef(int typeTag, Expr caseValue, Expr expr, Location loc) {
            super(CASE, loc);
            this.typeTag = typeTag ;
            this.expr = expr;
            this.caseValue = (Literal) caseValue ;
        }
    ...
    public static class Switch extends Expr {
    	...
    	public List<CaseDef> normalCaseExpr ; 
    	public CaseDef defaultCaseExpr ;
    	public Expr expr ;
        public Switch(Expr expr, List<CaseDef> normalCases, CaseDef defaultCase, Location loc) {
            super(CASES, loc);
            this.expr = expr ;
            this.normalCaseExpr = normalCases ;
            this.defaultCaseExpr = defaultCase;
        }
    	...
    	public void printTo(IndentPrintWriter pw) {
    		...
    		pw.incIndent();
  			...
  			pw.println("cases");
    		pw.incIndent();
  			for(CaseDef normalCase : normalCaseExpr)
  				normalCase.printTo(pw);
  			defaultCaseExpr.printTo(pw);
    		pw.decIndent();
    		pw.decIndent();
    	}
    }
    ...
    public static abstract class Visitor {
        ...
        public void visitCaseDef(CaseDef that) {
            visitTree(that);
        }
